...
public class InvoiceSlidingDrawer extends SlidingDrawer {

    public InvoiceSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
    ...
    public InvoiceSlidingDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
