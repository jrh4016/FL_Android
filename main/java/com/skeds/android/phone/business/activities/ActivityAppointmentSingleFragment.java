...
public class ActivityAppointmentSingleFragment extends BaseSkedsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_appointment_single_view_container);

        Fragment f = new AppointmentFragment();
        f.setArguments(getIntent().getExtras());

        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();

        transaction.add(R.id.appointment_single_container, f);
